...
return [
    ...
    'hello' => [['prenom', 'age'], ['prenom' => 'anonyme', 'age' => 0, '_controller' => 'App\\Controller\\HomeController::hello'], ['age' => '\\d+'], [['variable', '/', '\\d+', 'age', true], ['text', '/age'], ['variable', '/', '[^/]++', 'prenom', true], ['text', '/hello']], [], []],
    'hello_base' => [[], ['_controller' => 'App\\Controller\\HomeController::hello'], [], [['text', '/hello']], [], []],
    'hello_prenom' => [['prenom'], ['prenom' => 'anonyme', '_controller' => 'App\\Controller\\HomeController::hello'], [], [['variable', '/', '[^/]++', 'prenom', true], ['text', '/hello']], [], []],
