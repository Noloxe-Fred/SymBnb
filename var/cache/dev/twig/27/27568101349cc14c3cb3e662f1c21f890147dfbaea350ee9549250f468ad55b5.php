...
/* hello.html.twig */
class __TwigTemplate_ebd62f587241e7213aa2e63d79a3e516f509bb827c3f9e65090fdfcabae9d708 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <h1>Bonjour ";
        ...
        echo " vous avez ";
        echo twig_escape_filter($this->env, (isset($context["age"]) || array_key_exists("age", $context) ? $context["age"] : (function () { throw new RuntimeError('Variable "age" does not exist.', 5, $this->source); })()), "html", null, true);
        echo " ans</h1>
    <a href=\"/\">Accueil</a>
...
{% endblock %}
", "hello.html.twig", "/var/www/html/Symfony/udemy/SymBNB/symbnb/templates/hello.html.twig");
    }
}
